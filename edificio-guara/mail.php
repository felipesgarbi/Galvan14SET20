...
if (isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
	...
	// Google secret API
	$secretAPIkey = '6LdW2O8ZAAAAAOuEA8yLDmYgmMEDUexEwiY7YHb4';
	...
	if ($response->success) {
		...
		try {
			...
			$mail->Subject = 'Olá, seu cliente deseja receber informações deste empreendimento e ser acessado para possível atendimento';
			$mail->Body    = $texto;
			$mail->AltBody = '$texto';
