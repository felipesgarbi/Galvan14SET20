...
<body>
    ...
    <main>
        ...
        <div class="sidenav">
            ...
            <a href="#">PLANTAS</a>
            <a href="#">ANDAMENTO</a>
            <a href="#">QUERO MORAR</a>
        </div>

        <!--? Categories Area Start -->

        <div class="mainSidenav">
            <div class="single-projects-img pt-30">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-2">
                            <div class="about-caption mb-35">
                                <div class="section-tittle">
                                    ...
                                    <p>Localizado num dos melhores bairros de Joinville, o Saguaçu tem tudo que você
                                        precisa: escolas, mercados, bancos, academias, bares e restaurantes e parques
                                        e áreas de lazer.</p>

                                    <p>Criado para atender diversos públicos, o Residencial Ouro
        ...
        <!--?  Map Area start  -->
        <section class="Map-area w-padding3">
