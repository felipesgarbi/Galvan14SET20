        ...
        <section>
            <div class="tabs tabs-style-linebox">
                ...
                <div class="content-wrap">
                    ...
                    <div id="carouselFadeEmpreen" class="carousel slide carousel-fade carousel-inicio" data-interval="false" data-ride="carousel">
                                    ...
                                    <div class="grid">
                                        <a href="/edificio-guara">
                                            <figure class="effect-bubba">
                                                ...
                                                <img class="img_fundo" src="../assets/img/edificios/edGuara-(437x566)3.png" alt="img-edificios-logo-guara" />

                                                <figcaption class="margin-figcaption">

                                                    <h2 style="font-family: Daydream;  color: white;"><img class="img_logo" src="../assets/img/logo/LogoGuara.png" alt="img-logo-guara" /></h2>
                            ...
                            <div class="container-fluid p-0 fix">
                                <div class="row no-gutters ">
                                    <div class="col-xl-6 col-lg-6">
                                        ...
                                        <a href="../edificio-guara">
                                            <figure class="effect-bubba tamanho-empreendimento1">
                                            <img class="img_fundo ml-0" src="../assets/img/edificios/edGuara-(437x566)3.png" alt="edificio-guara-fundo-ml0"/>
                                                <figcaption>
